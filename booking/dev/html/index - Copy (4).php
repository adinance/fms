...
    text-transform: uppercase !important; /* บังคับให้เป็นตัวพิมพ์ใหญ่ทั้งหมด */
}
...
/* กล่องรวมของ multi-month */
body.dark-mode .fc-multimonth {
    background-color: transparent;
    border: none;
}

/* แถบชื่อเดือน (January) */
body.dark-mode .fc-multimonth-title {
    background-color: #1f1f1f;
    color: #e0e0e0;
    padding: 12px 0;
...
<body class="p-0 light-mode">
                    ...
                    <!-- <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="reportingDropdown">
                            <li class="nav-item dropend">
                                <a class="dropdown-item dropdown-toggle" href="#" id="nav-report-year" role="button"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    Year
                                </a>
                                <ul class="dropdown-menu" aria-labelledby="yearDropdown">
                                    <li><a class="dropdown-item" id="nav-report-current-year" href="#">Current Year</a>
                                    </li>
    ...
    <div id="mainLayout" class="d-flex flex-fill">
        ...
        <div id="sidebarMenu" class="d-flex flex-column flex-shrink-0 bg-light border-end p-2 collapsed">
            ...
            <ul id="meetingMenu" class="nav nav-pills flex-column mb-auto collapse show">
                ...
                <!-- <li class="nav-item"><a id="menu-meeting-reserve" href="#" class="nav-link"><i class="bi bi-dot"></i> <span>Booking List</span></a></li> -->
            </ul>
        ...
        <div id="mainContent" class="flex-grow-1 p-3">
            <div class="container" id="contentContainer">
                <!-- <div class="card p-3 shadow-sm mb-3">
                    <h2 class="mb-0">📅 Meeting Room</h2>
                </div> -->

                <div class="row">
                    <div class="col-md-8">
                        <!-- <div class="card p-4 shadow-lg mb-3 mt-4 main-calendar-card">
                            <div id="calendar"></div>
                        </div> -->
    ...
    <script>
        ...
        */
            ...
            function initTable() {
                // 1. 🚨 เพิ่มบรรทัดนี้: โหลดสถานะ Checkbox ก่อน (บังคับติ๊กทั้งหมดถ้าเป็นครั้งแรก)
                const initialRooms = loadRoomFilterState();
                // 2. ซิงค์ Calendar ตามสถานะ Checkbox ที่เพิ่งโหลดมา
