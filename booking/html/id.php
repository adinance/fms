...
.fc .fc-scrollgrid th {
	...
	box-shadow: inset 0 -1px 0 #333;
        ...
        /* --- Dark Mode Styles for DataTables Buttons (เพิ่มเข้าไปใน <style>) --- */
...
body.dark-mode .dataTables_wrapper .dt-buttons .btn:hover {
...
dom: 
'<"row"<"col-sm-12 col-md-7"l><"col-sm-12 col-md-3 text-md-end dt-buttons-right"f><"col-sm-12 col-md-2 text-md-end"B>>' +
'<"row spacer-row">' + 
'<"row"<"col-sm-12"t>>' +
'<"row"<"col-sm-12 col-md-5"i><"col-sm-12 col-md-7"p>>'
,
