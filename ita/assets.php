        ...
        <div class="grid grid-cols-12 grid-rows-[min-content] gap-y-12 p-4 lg:gap-x-12 lg:p-10">
                ...
                <div class="grow">
                    <div class="text-sm breadcrumbs p-4">
                        <ul class="flex items-center space-x-2 ">
                            <li class="lg:text-2xl lg:font-light"><strong>Assets</strong></li>
                            <li class="lg:text-2xl lg:font-light">All Assets</li>
                        </ul>
                    </div>
                ...
                <!-- <div> -->
                    ...
                    <dialog id="my_modal" class="modal">
                        <div class="modal-box w-11/12 max-w-5xl">
                            ...
                            <h3 class="font-bold text-lg mb-3">Assets</h3>

                            <form id="myForm" method="dialog" class="space-y-3">
						...
						<input type="email" name="email" placeholder="Enter email" class="input input-bordered w-full" />
                                ...
                                <section class="col-span-12 xl:col-span-4">
                                    ...
                                    <fieldset class="fieldset">
                                        ...
                                        <label class="label">
                                            <!-- <span class="label-text" for="datePurchased">Date</span></label> -->
                                            <!-- <input type="date" class="input input-bordered w-full" /> -->

                                            <!-- <input type="date" class="form-control" id="datePurchased" required> -->
                                    ...
                                    <fieldset class="fieldset">
                                        <div class="grid grid-cols-2 gap-4">
                                            <div>
                                                <label class="label">ASSETS NO.</label>
								...
								<input type="text" placeholder="Type here" class="input w-full">
                                    ...
                                    <fieldset class="fieldset">
                                        <div class="grid grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                <label class="label"><span class="label-text">Serial
                                                        Number</span></label>
                                    ...
                                    <fieldset class="fieldset">
                                        <div class="grid grid-cols-2 gap-4">
                                            <div>
                                                <label class="label"><span class="label-text">OS LICENSE</span></label>
                                                <input type="text" class="input input-bordered w-full mb-2" />
                                            </div>
                                            <div>
                                    ...
                                    <fieldset class="fieldset">
                                        <div class="grid grid-cols-4 gap-4">
                                            ...
                                            <div>
                                                <label class="label"><span class="label-text">GPU</span></label>
                                                <input type="text" class="input input-bordered w-full mb-2" />
                                            </div>
                                            <div>
                                            ...
                                            <div>
                                                <label class="label"><span class="label-text">STORAGE</span></label>
                                                <input type="text" class="input input-bordered w-full" />
                                            </div>
                                        </div>
                                    </fieldset>
							...
							<hr class="border-base-content/5 my-6 border-t-2"> -->
								...
								<div class="label justify-start gap-2">
									<svg data-src="https://unpkg.com/heroicons/20/solid/eye.svg" class="text-base-content/30 h-4 w-4"
										xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"
										data-slot="icon" data-id="svg-loader_2">
							...
							<label class="flex cursor-pointer gap-4">
								...
								<span class="label-text">Accept terms of use and privac policy</span>
                                    ...
                                    <fieldset class="fieldset">
                                        ...
                                        <div class="flex flex-wrap gap-6">
                                            ...
                                            <label class="flex items-center gap-2">
                                                <input type="radio" name="status" class="radio" value="Inactive" />
                                                <span>Inactive</span>
                                            </label>
                                            <label class="flex items-center gap-2">
                                                <input type="radio" name="status" class="radio" value="Repair" />
                                                <span>Repair</span>
                                            </label>
                                            <label class="flex items-center gap-2">
                                                <input type="radio" name="status" class="radio" value="Scrap" />
                                                <span>Scrap</span>
                                            </label>
                                        </div>
                                    </fieldset>
                                ...
                                <div class="modal-action">
                                    ...
                                    <button type="button" class="btn" onclick="my_modal.close()">Cancel</button>
            ...
            <div class="fixed bottom-4 right-4 z-50">
                <div class="fab fab-flower">
                    ...
                    <button class="btn btn-circle btn-lg btn-primary" onclick="my_modal.showModal()">
                    ...
                    <button class="btn btn-circle btn-lg btn-warning">
                        ...
                        <svg aria-label="New post" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"
        ...
        $(document).ready(function() {
            $('#example').DataTable({
                ...
                initComplete: function() {
                    ...
                    $('.dt-button.buttons-csv.buttons-html5').removeClass(
                        'dt-button buttons-csv buttons-html5').addClass(
                        'btn btn-sm w-18 rounded-full ');
                    ...
                    $('.dt-paging-button').removeClass('dt-paging-button').addClass(
                        'btn btn-sm w-10 rounded-full ');
                    $('.footer').css('display', 'flex').css('justify-content', 'space-between').css(
                        'align-items', 'center');
                }
            });
