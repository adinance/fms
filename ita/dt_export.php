...
<head>
  <meta charset="utf-8" />
  <title>DataTable Layout Example</title>
...
<body class="p-4">
  ...
  $(document).ready(function() {
    $('#example').DataTable({
      // ajax: 'https://cdn.datatables.net/1.13.8/data.json',
       data: [
      ...
      layout: {
        ...
        topStart: {
          buttons: [
            { text: 'top A', className: 'btn btn-outline-primary btn-sm' }
          ]
        },
        topEnd: {
          buttons: [
            { text: 'top B', className: 'btn btn-outline-primary btn-sm' },
            { text: 'top C', className: 'btn btn-outline-primary btn-sm' }
          ]
        },
