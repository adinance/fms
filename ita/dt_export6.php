...
<head>
    ...
    <title>DataTable with Aligned Entries and Pagination</title>
    ...
    $(document).ready(function() {
        var table = $('#example').DataTable({
            ...
            buttons: [
                ...
                { 
                    extend: 'csv',  
                    className: 'btn btn-outline btn-primary btn-sm w-32 rounded-full', 
                    text: 'CSV' 
                },
                { 
                    extend: 'pdf',  
            ...
            initComplete: function() {
                ...
                // Wrap the footer elements for better alignment
