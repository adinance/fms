		...
		<main class="drawer-content">
			<div class="grid grid-cols-12 grid-rows-[min-content] gap-y-12 p-4 lg:gap-x-12 lg:p-10">
				...
				<!-- <section class="card bg-base-100 col-span-12 shadow-xs xl:col-span-4">
					...
					<tc-line
						class="rounded-box h-full w-full [--area-opacity:.2] [--shape-color:#19D6BF]"
				...
				<section class="card bg-base-100 col-span-12 shadow-xs xl:col-span-4">
					...
					<tc-line
						class="rounded-box h-full w-full [--area-opacity:.2] [--shape-color:#A838FF]"
						values="[12,10,12,4,13,16,14,10,12,11,17,18,16,17,20,14,15,13,12,14]"
						min="0"></tc-line>
				</section> -->
							...
							<tbody>
								<tr>
									...
									<td>
										<svg
											data-src="https://unpkg.com/heroicons/20/solid/arrow-up-right.svg"
											class="text-success inline-block h-5 w-5"
											xmlns="http://www.w3.org/2000/svg"
											viewBox="0 0 20 20"
											fill="currentColor"
											aria-hidden="true"
								...
								<tr>
									...
									<td>
										<svg
											data-src="https://unpkg.com/heroicons/20/solid/arrow-down-right.svg"
											class="text-error inline-block h-5 w-5"
											xmlns="http://www.w3.org/2000/svg"
											viewBox="0 0 20 20"
											fill="currentColor"
											aria-hidden="true"
				...
				<ul class="menu w-full">
					...
					<li>
						<details>
							...
							<ul>
								<!-- <li><a><svg data-src="https://unpkg.com/heroicons/20/solid/user.svg" class="h-5 w-5"></svg>Users</a></li> -->
								<li><a>Brand</a></li>
							</ul>
						</details>
					</li>
